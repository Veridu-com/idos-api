...
class DatabaseInit extends AbstractMigration {
	...
	public function change() {
		...
		$identities
			...
			->addColumn('created', 'timestamp', ['null' => false, 'timezone' => false, 'default' => 'CURRENT_TIMESTAMP'])
			->addColumn('updated', 'timestamp', ['null' => false, 'timezone' => false, 'default' => 'CURRENT_TIMESTAMP'])
			->addIndex('public_key')
			->create();
		...
		$credentials
			...
			->addColumn('private', 'binary', ['null' => false])
