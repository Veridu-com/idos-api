...
class CreateNewTest extends AbstractFunctional {
    ...
    protected function setUp() {
        ...
        $this->uri        = '/1.0/profiles/f67b96dcf96b49d713a520ce9f54053c/sources/1860914067/digested';
    }
    ...
    public function testNameTooLong() {
        ...
        $request = $this->createRequest(
            ...
            json_encode(
                [
                    'name'  => 'New nameNew nameNew nameNew nameNew nameNew nameNew nameNew nameNew name',
                    'value' => 'new value'
                ]
            )
        );
