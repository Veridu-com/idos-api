...
class ListAllTest extends AbstractFunctional {
    ...
    public function testSuccess() {
        ...
        $this->assertSame('idOS FB Scraper', $body['data'][0]['name']);
        $this->assertSame('https://scraper.idos.io', $body['data'][0]['url']);
        ...
        $this->assertSame('idOS FB Data Mapper', $body['data'][1]['name']);
