...
class UpdateOneTest extends AbstractFunctional {
    ...
    protected function setUp() {
        ...
        $this->httpMethod = 'PUT';
        $this->populate(
            '/1.0/companies/veridu-ltd/profiles/517015180/reviews',
            'GET',
            [
        ...
        $this->uri    = sprintf('/1.0/companies/veridu-ltd/profiles/517015180/reviews/%s', $this->entity['id']);
    }
    ...
    public function testInvalidFlag() {
        ...
        $request = $this->createRequest($environment, json_encode(['positive' => 'notaboolean']));
