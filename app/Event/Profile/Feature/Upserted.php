 ...
 * Upserted event.
 */
class Upserted extends AbstractServiceQueueEvent {
    /**
     ...
     * @return void
     */
    public function __construct(Feature $feature, User $user, Process $process, Credential $credential, $source = null) {
    ...
    public function __toString() {
        return sprintf('idos:feature.%s.upserted', $this->source ? $this->source->name : 'profile');
    }
}
