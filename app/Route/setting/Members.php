...
class Members implements RouteInterface {
     ...
     *
     * @apiEndpoint GET /companies/{companySlug}/members/{pubKey}
     * @apiGroup Company Members
     * @apiAuth header key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiAuth query key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiEndpointURIFragment string companySlug veridu-ltd
    ...
    private static function getOne(App $app, callable $auth, callable $permission) {
        $app
            ->get(
                '/companies/{companySlug:[a-zA-Z0-9_-]+}/members/{pubKey:[a-zA-Z0-9]+}',
     ...
     *
     * Updates Member's specific information
     *
     * @apiEndpoint PUT /companies/{companySlug}/members/{pubKey}
     * @apiGroup Company Members
     * @apiAuth header key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiAuth query key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiEndpointURIFragment string companySlug veridu-ltd
     ...
     *
     * @apiEndpoint DELETE /companies/{companySlug}/members/{pubKey}
     * @apiGroup Company Members
     * @apiAuth header key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiAuth query key compPrivKey 2f476be4f457ef606f3b9177b5bf19c9 Company's Private Key
     * @apiEndpointURIFragment string companySlug veridu-ltd
