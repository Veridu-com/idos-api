...
class Handler implements HandlerInterface {
    ...
    public function handleCreateNew(CreateNew $command) : HandlerEntity {
        ...
        try {
            ...
            throw new Create\HandlerException('Error while trying to create a feature', 500, $e);
        }
    ...
    public function handleUpdateOne(UpdateOne $command) : HandlerEntity {
        ...
        $entity = $this->repository->findOne($command->handlerId, $command->company);

        // Any thoughts on a better place of verifying this
        if ($command->company->id != $entity->companyId) {
            throw new NotAllowed\HandlerException('Handler doesnt belong to the given company', 403);
        }
