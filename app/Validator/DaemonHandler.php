...
/**
 * DaemonHandler Validation Rules.
 */
class DaemonHandler implements ValidatorInterface {
    /**
     ...
     * @return void
     */
    public function assertStep($value) {
        Validator::stringType()
            ->assert($value);
    }
     ...
     * @return void
     */
    public function assertRunLevel($value) {
        Validator::digit()
            ->assert($value);
    }
